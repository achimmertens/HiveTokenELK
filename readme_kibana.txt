...
- (adapt the tokenname and) Insert the content of put_index.json, adjust the tokenname and execute it.
...
- Create the index pattern for the token (i.e. *leo) and name the ID "token_index_pattern_id" (i.e. "leo_index_pattern_id")
