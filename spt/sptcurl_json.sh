...
curl -XPOST -H "Content-type: application/json" -d '{ "jsonrpc": "2.0", "method": "find", "params": { "contract": "market", "table": "tradesHistory", "query": { "symbol": "SPT"}, "limit":1000, "offset": 0 }, "id": 1 }' 'https://herpc.kanibot.com/contracts' > $LOG
